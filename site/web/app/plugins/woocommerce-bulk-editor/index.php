<?php
/*
  Plugin Name: WOOBE - WooCommerce Bulk Editor and Products Manager
...
define('WOOBE_VERSION', '2.0.6');
define('WOOBE_MIN_WOOCOMMERCE_VERSION', '3.4');
...
include WOOBE_PATH . 'classes/rate_alert.php';
...
//***
        ...
        if (isset($_GET['page']) AND $_GET['page'] == 'woobe') {
            ...
            add_action('admin_notices', function() {
                ...
                if (!get_user_meta($user_id, 'woobe_notice_dismissed')) {
                    echo '<div class="notice notice-warning"><p>' . sprintf(__('If you not familiar with the plugin, firstly %s please', 'woocommerce-bulk-editor'), WOOBE_HELPER::draw_link(array(
                                'title' => __('visit this page', 'woocommerce-bulk-editor'),
        ...
        add_action('admin_menu', function() {
            add_submenu_page('edit.php?post_type=product', 'WOOBE ' . __('Bulk Editor', 'woocommerce-bulk-editor'), 'WOOBE ' . __('Bulk Editor', 'woocommerce-bulk-editor'), 'manage_woocommerce', 'woobe', function() {
        ...
        add_action('admin_bar_menu', function($wp_admin_bar) {
            ...
            if ($show) {
                $args = array(
                    'id' => 'woobe-btn',
                    'title' => 'WOOBE ' . __('Bulk Editor', 'woocommerce-bulk-editor'),
...
//***
        ...
        $this->rate_alert = new WOOBE_RATE_ALERT($this->show_notes);
    }
    ...
    public function plugin_action_links($links) {
        ...
        return array_merge(array(
            '<a href="' . admin_url('edit.php?post_type=product&page=woobe') . '">' . __('Products Editor', 'woocommerce-bulk-editor') . '</a>',
            '<a target="_blank" href="https://bulk-editor.com/"><span class="icon-book"></span>&nbsp;' . __('Documentation', 'woocommerce-bulk-editor') . '</a>'
                ), $links);
    }
    ...
    public function admin_enqueue_scripts() {
        if (isset($_GET['page']) AND $_GET['page'] == 'woobe') {
            ...
            <script>
                var lang = {
                    move: "<?php echo __('move', 'woocommerce-bulk-editor') ?>",
                    search: "<?php echo __('Search', 'woocommerce-bulk-editor') ?>",
                    rest_failed: "<?php echo __('Failed', 'woocommerce-bulk-editor') ?>",
                    error: "<?php echo __('Error', 'woocommerce-bulk-editor') ?>",
                    delete: "<?php echo __('delete', 'woocommerce-bulk-editor') ?>",
                    ignore: "<?php echo __('ignore', 'woocommerce-bulk-editor') ?>",
                    no_deletable: "<?php echo __('This is not deletable!', 'woocommerce-bulk-editor') ?>",
                    no_items: "<?php echo __('no items', 'woocommerce-bulk-editor') ?>",
                    none: "<?php echo __('none', 'woocommerce-bulk-editor') ?>",
                    no_data: "<?php echo __('no data', 'woocommerce-bulk-editor') ?>",
                    loading: "<?php echo __('Loading', 'woocommerce-bulk-editor') ?> ...",
                    loaded: "<?php echo __('Loaded', 'woocommerce-bulk-editor') ?>.",
                    saved: "<?php echo __('Saved', 'woocommerce-bulk-editor') ?>.",
                    saving: "<?php echo __('Saving', 'woocommerce-bulk-editor') ?> ...",
                    apply: "<?php echo __('Apply', 'woocommerce-bulk-editor') ?>",
                    cancel: "<?php echo __('Cancel', 'woocommerce-bulk-editor') ?>",
                    canceled: "<?php echo __('Canceled', 'woocommerce-bulk-editor') ?>",
                    sure: "<?php echo __('Sure?', 'woocommerce-bulk-editor') ?>",
                    creating: "<?php echo __('Creating', 'woocommerce-bulk-editor') ?> ...",
                    created: "<?php echo __('Created!', 'woocommerce-bulk-editor') ?>",
                    duplicating: "<?php echo __('Duplicating', 'woocommerce-bulk-editor') ?> ...",
                    duplicated: "<?php echo __('Duplicated!', 'woocommerce-bulk-editor') ?>",
                    deleting: "<?php echo __('Deleting', 'woocommerce-bulk-editor') ?> ...",
                    deleted: "<?php echo __('Deleted!', 'woocommerce-bulk-editor') ?>",
                    reseting: "<?php echo __('Reseting', 'woocommerce-bulk-editor') ?> ...",
                    reseted: "<?php echo __('Reseted!', 'woocommerce-bulk-editor') ?>",
                    upload_image: "<?php echo __('Upload image', 'woocommerce-bulk-editor') ?>",
                    upload_images: "<?php echo __('Upload images', 'woocommerce-bulk-editor') ?>",
                    upload_file: "<?php echo __('Upload file', 'woocommerce-bulk-editor') ?>",
                    fill_up_data: "<?php echo __('Fill up the data please!', 'woocommerce-bulk-editor') ?>",
                    enter_duplicate_count: "<?php echo __('Enter how many time duplicate selected product(s)!', 'woocommerce-bulk-editor') ?>",
                    enter_new_count: "<?php echo __('Enter how many new product(s) to create!', 'woocommerce-bulk-editor') ?>",
                    search_input_placeholder: "<?php echo __('Text search by title or SKU', 'woocommerce-bulk-editor') ?>",
                    show_panel: "<?php _e('Show: Filters/Bulk Edit/Export', 'woocommerce-bulk-editor') ?>",
                    close_panel: "<?php _e('Hide: Filters/Bulk Edit/Export', 'woocommerce-bulk-editor') ?>",
                    per_page: "<?php _e('Per page', 'woocommerce-bulk-editor') ?>",
                    color_picker_col: "<?php _e('Select background color', 'woocommerce-bulk-editor') ?>",
                    color_picker_txt: "<?php _e('Select text color', 'woocommerce-bulk-editor') ?>",
                    sEmptyTable: "<?php _e('No data available in the table', 'woocommerce-bulk-editor') ?>",
                    sInfo: "<?php _e('Showing _START_ to _END_ of _TOTAL_ entries', 'woocommerce-bulk-editor') ?>",
                    sInfoEmpty: "<?php _e('Showing 0 to 0 of 0 entries', 'woocommerce-bulk-editor') ?>",
                    sInfoFiltered: "<?php _e('(filtered from _MAX_ total entries)', 'woocommerce-bulk-editor') ?>",
                    sLoadingRecords: "<?php _e('Loading...', 'woocommerce-bulk-editor') ?>",
                    sProcessing: "<?php _e('Processing...', 'woocommerce-bulk-editor') ?>",
                    sZeroRecords: "<?php _e('No matching records found', 'woocommerce-bulk-editor') ?>",
                    sFirst: "<?php _e('First', 'woocommerce-bulk-editor') ?>",
                    sLast: "<?php _e('Last', 'woocommerce-bulk-editor') ?>",
                    sNext: "<?php _e('Next', 'woocommerce-bulk-editor') ?>",
                    sPrevious: "<?php _e('Previous', 'woocommerce-bulk-editor') ?>",
                    action_state_1: "<?php _e('all the products on the site', 'woocommerce-bulk-editor') ?>",
                    action_state_2: "<?php _e('the filtered products. To remove the products filtering press reset button on the tools panel below', 'woocommerce-bulk-editor') ?>",
                    action_state_31: "<?php _e('the selected products (variations)', 'woocommerce-bulk-editor') ?>",
                    action_state_32: "<?php _e('You can reset selection of the products by its reset button on the panel of the editor OR uncheck them manually!', 'woocommerce-bulk-editor') ?>",
                    term_maybe_exist: "<?php _e('Maybe term(s) with such name(s) already exists!', 'woocommerce-bulk-editor') ?>",
                    free_ver_profiles: "<?php _e('In FREE version of the plugin you can create one profile only!', 'woocommerce-bulk-editor') ?>",
                    append_sub_item: "<?php _e('append sub item', 'woocommerce-bulk-editor') ?>",
                    is_deactivated_in_free: "<?php _e('This field is deactivated in FREE version for bulk edit!', 'woocommerce-bulk-editor') ?>"
                };
...
//***
            ...
            wp_enqueue_script('woobe_modernizr', WOOBE_ASSETS_LINK . 'js/modernizr.js', array(), WOOBE_VERSION);
...
//***
        ...
        $args['rate_alert'] = $this->rate_alert->show_alert();
...
//buttons: edit + view
            $row[] = WOOBE_HELPER::draw_link(array(
                        ...
                        'title_attr' => __('View the product on the site front', 'woocommerce-bulk-editor')
                    )) . '&nbsp;' . WOOBE_HELPER::draw_link(array(
                        'title' => '&#xea25;',
                        'href' => get_admin_url() . 'post.php?post=' . $p['ID'] . '&action=edit',
                        'target' => '_blank',
                        'class' => 'button button-primary button-small',
                        'title_attr' => __('Editing of the product on its page', 'woocommerce-bulk-editor')
            ));
        } else {
            $row[] = '';
        }
...
//ajax
    public function woobe_title_autocomplete() {
        $results = array();
        $results[] = array(
            "name" => __("Products not found!", 'woocommerce-bulk-editor'),
            "id" => 0,
            "type" => "",
            "link" => "#",
...
//also: http://woocommerce.wp-a2z.org/oik_api/wc_api_productscreate_product/
        ...
        $wp_rest_request->set_body_params(array(
            'name' => __('New Product', 'woocommerce-bulk-editor'),
            'description' => '',
            'status' => 'draft'
        ));
...
//using for products selection
        ...
        if ($field_key === 'ID') {
            ...
            if ($product->get_type() === 'variable') {
                ...
                $title = __('see the product on the site OR select products variations if they are shown', 'woocommerce-bulk-editor');
            }
