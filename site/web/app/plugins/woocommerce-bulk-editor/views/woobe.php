...
<div class="wrap nosubsub" style="margin-top: 0;">
    ...
    <section class="woobe-section">
        ...
        <h3 style="margin-top: 0;  margin-bottom: 31px; color: orangered;"><?php printf('WOOBE - WooCommerce Bulk Editor Professional v.%s', WOOBE_VERSION) ?></h3>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 25%;">
                ...
                <a href="https://bulk-editor.com/a/buy" target="_blank"><img src="<?php echo WOOBE_LINK ?>assets/images/woobe_banner.png" style="width: 100%" alt="<?php _e("WOOBE - WooCommerce Bulk Editor Professional", 'woocommerce-bulk-editor'); ?>" /></a>
            </td>

            <td style="width: 25%;">
                <h4 style="color: tomato;"><?php _e("WPBE - WordPress Posts Bulk Editor", 'woocommerce-bulk-editor') ?></h4>
                <a href="https://pluginus.net/affiliate/wordpress-posts-bulk-editor" target="_blank"><img src="<?php echo WOOBE_LINK ?>assets/images/wpbe_banner.jpg" style="width: 100%" alt="<?php _e("WPBE - WordPress Posts Bulk Editor Professional", 'woocommerce-bulk-editor'); ?>" /></a>
            </td>
