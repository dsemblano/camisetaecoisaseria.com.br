...
<b>
    <?php
    printf(esc_html('The plugin has %s and "%s" list. Also if you have troubles you can %s!', 'woocommerce-bulk-editor'), WOOBE_HELPER::draw_link(array(
                'href' => 'https://bulk-editor.com/documentation/',
                'title' => esc_html('documentation', 'woocommerce-bulk-editor'),
                'target' => '_blank'
            )), WOOBE_HELPER::draw_link(array(
                'href' => 'https://bulk-editor.com/how-to-list/',
                'title' => esc_html('How to', 'woocommerce-bulk-editor'),
                'target' => '_blank'
            )), WOOBE_HELPER::draw_link(array(
                'href' => 'https://pluginus.net/support/forum/woobe-woocommerce-bulk-editor-professional/',
                'title' => '<b style="color: orange;">' . esc_html('ask for support here', 'woocommerce-bulk-editor') . '</b>',
...
<ol>
    ...
    <li><?php
        printf(__('If your shop is on the Russian language you should install %s for the correct working of WOOBE with Cyrillic', 'woocommerce-bulk-editor'), WOOBE_HELPER::draw_link(array(
...
<ul>
    <li style="padding: 7px; border: dashed 1px orange; border-radius: 3px; margin-bottom: 9px;">
        <?php
        printf(__('If you like WOOBE %s about what you liked and what you want to see in future versions of the plugin', 'woocommerce-bulk-editor'), WOOBE_HELPER::draw_link([
...
<ul>
    ...
    <li><?php _e('Recommended PHP version', 'woocommerce-bulk-editor') ?>: 7.xx</li>
</ul><br />
