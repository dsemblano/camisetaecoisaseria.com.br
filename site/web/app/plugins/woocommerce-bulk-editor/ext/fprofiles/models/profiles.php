...
class WOOBE_FILTER_PROFILES extends WOOBE_PROFILES {
        ...
        if (!$this->get()) {
            ...
            $this->create(array(
                'product_type' => 'variable'
                    ), __('Variable products', 'woocommerce-bulk-editor'), 'default');
        }
    }
    ...
    public function load_profile() {
        ...
        if (isset($_REQUEST['saved_fprofile']) AND $_REQUEST['saved_fprofile']) {
            update_user_meta(get_current_user_id(), "woobe_fprofile_saved", $_REQUEST['profile_key']);
        } else {
