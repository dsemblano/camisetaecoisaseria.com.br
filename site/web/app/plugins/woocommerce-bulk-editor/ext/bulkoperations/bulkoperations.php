...
final class WOOBE_BULKOPERATIONS extends WOOBE_EXT {
    ...
    public function woobe_ext_scripts() {
        ...
        <script>
            ...
            lang.<?php echo $this->slug ?>.going = '<?php _e('ATTENTION: Variations Advanced Bulk Operation is going', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.finished = '<?php _e('Variations Advanced Bulk Operation is finished', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.finished2 = '<?php _e('Attaching of the default combination for the products variations is finished!', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.finished3 = '<?php _e('Deleting of the products variations is finished', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.finished4 = '<?php _e('Ordering of the products variations is finished', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.finished5 = '<?php _e('Swap of variations is finished', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.finished6 = '<?php _e('Attaching of the products variations is finished', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.generating = '<?php _e('Generating possible combinations', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.generated = '<?php _e('Possible combinations been generated.', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.no_combinations = '<?php _e('Combination(s) not selected!', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.not_selected_var = '<?php _e('variation is not selected', 'woocommerce-bulk-editor') ?>';
            lang.<?php echo $this->slug ?>.no_vars = '<?php _e('the product has no variations', 'woocommerce-bulk-editor') ?>';
        </script>
        <?php
    }
    ...
    public function woobe_tools_panel_buttons() {
        ?>
        <a href="#" class="button button-secondary woobe_tools_panel_newvars_btn" title="<?php _e('Variations Advanced Bulk Operations', 'woocommerce-bulk-editor') ?>"></a>
        <?php
    }
