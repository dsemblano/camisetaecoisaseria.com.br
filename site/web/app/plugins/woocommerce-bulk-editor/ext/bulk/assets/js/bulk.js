...
jQuery(function ($) {
    ...
    jQuery('.woobe_bulk_terminate').click(function () {
        woobe_bulk_terminate();
        return false;
    });
...
function woobe_init_bulk_panel() {
    ...
    jQuery('.bulk_checker').click(function () {
        var disable = false;
    ...
    jQuery('#woobe_bulk_products_btn').click(function () {
    ...
    function woode_check__delete_products_btn() {
        var check = jQuery('#woobe_bulk_delete_products_btn_fuse').attr("checked");
        //console.log(check);
        if (check == 'checked') {
    ...
    jQuery('#woobe_bulk_delete_products_btn_fuse').click(function () {
        woode_check__delete_products_btn();
    });
//DELETE!!!
    jQuery('#woobe_bulk_delete_products_btn').click(function () {
        if (jQuery('#woobe_bulk_delete_products_btn_fuse').attr("checked") != 'checked') {
            return false;
        }
...
//END DELETE!!!
    //***
    //variation targeting
    jQuery('#woobe_bulk_add_combination_to_apply').click(function () {
        ...
        if (jQuery(select).val()) {
            ...
            jQuery.ajax({
                ...
                success: function (html) {
                    ...
                    jQuery('.woobe_bulk_get_att_terms_del').click(function () {
...
function woobe_bulk_init_additional() {
    ...
    jQuery('#woobe_bulk_select_thumb_btn').click(function ()
    {
