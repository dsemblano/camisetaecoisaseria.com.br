...
jQuery(function ($) {
    ...
    jQuery('.woobe_filter_select').change(function () {
    ...
    //Filter button
    jQuery('#woobe_filter_products_btn').click(function () {
    ...
    //Reset Filter button
    jQuery('.woobe_filter_reset_btn1, .woobe_filter_reset_btn2').click(function () {
    ...
    jQuery('.woobe_filter_tools_select[name="woobe_filter_tools_options"]').change(function(){
    ...
    jQuery('#woobe_filter_btn_tools_panel').click(function () {
    ...
    jQuery("input[name='woobe_filter_form_tools_value']").unbind().bind('keyup change', function (e) {
        if (e.keyCode === 13) {
